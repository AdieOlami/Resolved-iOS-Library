...
//import UIKit
//
//public final class HelpCenterViewController: BaseViewController {
//    public weak var delegate: HelpCenterViewControllerDelegate?
//    private let customerId: String?
//    private let customerEmail: String?
//    private let customerName: String?
//    private let customerMetadata: [String: Any]?
//    
//    private var currentView: HelpCenterView = .home
//    private var faqs: [FAQ] = []
//    private var searchResults: [FAQ] = []
...
//        let label = createStyledLabel(text: "Help Center", style: .heroTitle)
//        label.textAlignment = .center
//        label.textColor = .white
//        return label
//    }()
//    
//    private lazy var heroSubtitle: UILabel = {
//        let label = createStyledLabel(text: "Find answers, get support, and discover everything you need to succeed with our platform", style: .body)
//        label.textAlignment = .center
...
//        container.layer.cornerRadius = theme.mediumCornerRadius
...
//        searchBar.placeholder = "Search for help topics, articles, or troubleshooting guides..."
...
//    }()
//    
//    private lazy var faqSectionTitle: UILabel = {
//        let label = createStyledLabel(text: "Frequently Asked Questions", style: .title)
//        label.textAlignment = .center
//        return label
//    }()
//    
...
//
//extension HelpCenterViewController: UISearchBarDelegate {
...
//        searchFAQs(query: searchText)
//    }
//    
//    public func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
//        searchBar.resignFirstResponder()
//        if let text = searchBar.text {
//            searchFAQs(query: text)
//        }
//    }
//}
